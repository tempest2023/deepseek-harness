...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/jev/jev': { kind: 'indirect', reason: 'The plugin changes only the request header — the routed provider/model and the exposed tool schemas — through installModelSelection and the prompt-assembly waterfall.' },
