...
| `ctx.jev` | `core` | [`jev`](../packages/jev/jev) | - | - | - | Answers bounded routing, tool-relevance, and permission questions while the agent loop and tool pipeline retain orchestration and enforcement. |
